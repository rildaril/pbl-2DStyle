          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><strong>BCA</strong> 1122334455</li>
                    <li class="list-group-item"><strong>BNI</strong> 1357908642</li>
                    <li class="list-group-item">a.n. 2DStyle Company</li>
                </ul>
            </div>
        </div>
      </div>
